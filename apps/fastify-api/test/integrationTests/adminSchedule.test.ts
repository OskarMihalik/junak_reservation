...
export const adminScheduleAPITests = () => {
  ...
  describe('Admin schedule API Integration Tests (live DB)', () => {
    ...
    it('should POST schedule', async () => {
      const requestBody = {
        ...
        date: '2024-12-04', // A valid ISO 8601 date string
        section: [
          {
            startAt: '2024-12-04T09:00:00Z',
            interval: 15, // A multiple of 5
            capacity: 10, // Positive integer
            endAt: '2024-12-04T09:15:00Z',
          },
          {
            startAt: '2024-12-04T10:00:00Z',
            interval: 30, // A multiple of 5
            capacity: 20, // Positive integer
            endAt: '2024-12-04T10:30:00Z',
          },
        ],
      };
      ...
      const requestBody = [
        {
          ...
          section: [
            {
              startAt: '2024-12-05T09:00:00Z',
              interval: 15, // Multiple of 5
              capacity: 10, // Positive integer
              endAt: '2024-12-05T09:15:00Z',
            },
            {
              startAt: '2024-12-05T10:00:00Z',
              interval: 30, // Multiple of 5
              capacity: 20, // Positive integer
              endAt: '2024-12-05T10:30:00Z',
            },
          ],
        },
        {
          ...
          section: [
            {
              startAt: '2024-12-06T09:00:00Z',
              interval: 30, // Multiple of 5
              capacity: 15, // Positive integer
              endAt: '2024-12-06T09:30:00Z',
            },
          ],
        },
      ];
    ...
    it('should UPDATE schedule', async () => {
      const requestBody = {
        ...
        date: '2024-12-08', // A valid ISO 8601 date string
        section: [
          {
            startAt: '2024-12-08T09:00:00Z',
            interval: 15, // A multiple of 5
            capacity: 10, // Positive integer
            endAt: '2024-12-08T09:15:00Z',
          },
          {
            startAt: '2024-12-08T10:00:00Z',
            interval: 30, // A multiple of 5
            capacity: 20, // Positive integer
            endAt: '2024-12-08T10:30:00Z',
          },
        ],
      };
